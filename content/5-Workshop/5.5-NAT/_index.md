...
![Allocate Elastic IP window](/images/5-Workshop/5.5-NAT/elastic-IP-allocate.png)
...
![Create NAT Gateway screen with selected subnet + EIP](/images/5-Workshop/5.5-NAT/NAT-creation.png)
...
![NAT Gateway state](/images/5-Workshop/5.5-NAT/NAT-state.png)
